...
function TulipIcon({ size }: { size: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M20 22C20 22 14 21 12 17C10 13 13 8 13 8C13 8 16 11 20 11C24 11 27 8 27 8C27 8 30 13 28 17C26 21 20 22 20 22Z"
        fill="#D93A2F"
        stroke="#D93A2F"
        strokeWidth="0.5"
